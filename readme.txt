...
1. Upload directory `wp-login-logo` to the `/wp-content/plugins/` directory
...
= Where do I upload an image? =

The path settings of the Plugin is "Settings -> WP Login Logo"
...
* Add Bootstrap Featured
* Change Admin Page Design
